...
#define SF_CORE_TRACE(...)		do {} while(false)
#define SF_CORE_DEBUG(...)		do {} while(false)
#define SF_CORE_INFO(...)		do {} while(false)
#define SF_CORE_WARN(...)		do {} while(false)
#define SF_CORE_ERROR(...)		SPDLOG_LOGGER_ERROR(StarFire::Log::GetCoreLogger(), __VA_ARGS__)
#define SF_CORE_CRITICAL(...)	SPDLOG_LOGGER_CRITICAL(StarFire::Log::GetCoreLogger(), __VA_ARGS__)

#define SF_TRACE(...)			do {} while(false)
#define SF_DEBUG(...)			do {} while(false)
#define SF_INFO(...)			do {} while(false)
#define SF_WARN(...)			do {} while(false)
#define SF_ERROR(...)			SPDLOG_LOGGER_ERROR(StarFire::Log::GetClientLogger(), __VA_ARGS__)
#define SF_CRITICAL(...)		SPDLOG_LOGGER_CRITICAL(StarFire::Log::GetClientLogger(), __VA_ARGS__)
	
#define SF_R_CORE_DEBUG(file, func, line, ...)		do {} while(false)
#define SF_R_CORE_TRACE(file, func, line, ...)		do {} while(false)
#define SF_R_CORE_INFO(file, func, line, ...)		do {} while(false)
#define SF_R_CORE_WARN(file, func, line, ...)		do {} while(false)
#define SF_R_CORE_ERROR(file, func, line, ...)		StarFire::Log::GetRendererLogger()->log(spdlog::source_loc{file, line, func}, spdlog::level::err, __VA_ARGS__)
#define SF_R_CORE_CRITICAL(file, func, line, ...)	StarFire::Log::GetRendererLogger()->log(spdlog::source_loc{file, line, func}, spdlog::level::critical, __VA_ARGS__)
...
#define SF_CORE_INFO(...)		do {} while(false)
#define SF_CORE_WARN(...)		do {} while(false)
#define SF_CORE_ERROR(...)		do {} while(false)
#define SF_CORE_CRITICAL(...)	do {} while(false)

#define SF_TRACE(...)			do {} while(false)
#define SF_DEBUG(...)			do {} while(false)
#define SF_INFO(...)			do {} while(false)
#define SF_WARN(...)			do {} while(false)
#define SF_ERROR(...)			do {} while(false)
#define SF_CRITICAL(...)		do {} while(false)

#define SF_R_CORE_TRACE(...)	do {} while(false)
#define SF_R_CORE_DEBUG(...)	do {} while(false)
#define SF_R_CORE_INFO(...)		do {} while(false)
#define SF_R_CORE_WARN(...)		do {} while(false)
#define SF_R_CORE_ERROR(...)	do {} while(false)
#define SF_R_CORE_CRITICAL(...)	do {} while(false)
#endif
