...
Visual Studio 2026, C++23, x64

[VulkanSDK](https://vulkan.lunarg.com/sdk/home#windows) Version 1.4
...
|[VulkanSDK](https://vulkan.lunarg.com/sdk/home#windows)|1.4.350.0(latest 1.4)|Original|---|---|12.05.2026|Aurora|all|
...
|[ImGui](https://github.com/ocornut/imgui)|---|Forked|[Docking](https://github.com/PowerOfNames/imgui/tree/docking)|'f5f6ca0'|03.2026|StarFire;Aurora;Nebula;Sandbox|all|
...
2. Install the latest 1.4.xxx VulkanSDK for Windows 64 bit and set the system environment variable (default: Vulkan_SDK)
